...
func TestEveryPageRenders(t *testing.T) {
	...
	pages := map[string]any{
		...
		"profile":      profileData{Owner: user, Builds: []store.Build{build}, Pinned: []store.Build{build}, Trophies: []store.Trophy{trophy}, Friendship: "incoming", Page: listPage{Page: 1, Pages: 1, Total: 1}},
		...
		"stash": stashData{Items: []store.StashItem{kit}, Tomorrow: "2026-06-02", Filter: "building", Filters: stashFilters,
			Page:    listPage{Page: 1, Pages: 2, Total: 55, Next: "/stash?page=2"},
			Summary: stashSummary{Waiting: 1, DebtPence: 1299, Oldest: "Lancaster", OldestDays: 40, Next: &kit, GoalDone: 1, GoalDaysLeft: -3}},
		"members":     membersData{Query: "jo", Members: []store.Member{member}, Capped: true},
		...
		"competition": competitionData{Competition: comp, Entries: []store.Entry{entry}, Trophies: []store.Trophy{trophy}, MyBuilds: []buildChoice{{Build: build, Entered: true}}, CanEnter: true, CanVote: true, ShowVotes: true},
